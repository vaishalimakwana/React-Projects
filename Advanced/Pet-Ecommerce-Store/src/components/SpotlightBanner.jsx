...
import SpotLightBannerM from '../assets/SpotLightBanner-m.jpg';
const SpotlightBanner = () => {
  return (
    <div className="bg-brandcolor lg:pt-24 pt-16 pb-16">
      <div
        className="hidden md:block relative max-w-7xl mx-auto md:rounded-2xl pt-28 bg-cover 
      ...
      <div
        className="block md:hidden relative max-w-7xl mx-auto md:rounded-2xl pt-28 bg-cover 
        bg-center h-[550px] md:h-[600px] "
        style={{
          backgroundImage: `url(${SpotLightBannerM})`,
          backgroundPosition: 'Top',
        }}
      >
        <div
